...
function Footer() {
  return (
   ...
   {/* <nav class="flex flex-row  justify-center border-b border-gray-100 text-sm font-medium w-full">
  <a href="#" class="-mb-px flex-1 border-b border-current p-4 text-cyan-500">
    Bronze
  </a>

  <a href="#" class="-mb-px flex-1  border-b border-transparent p-4 hover:text-cyan-500">
    Silver
  </a>
  ...
  <a href="#" class=" border-b flex-1 bg-teal-500  border-transparent p-4 hover:text-cyan-500">
    Platinum
  </a>
</nav> */}
